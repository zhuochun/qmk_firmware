 ...
 *    `---------------------------------'                                       `---------------------------------'
 *                                       ,--------------.       ,---------------.
 *                                       | Space |EntAlt|       |  Up  |  Down  |
 *                               ,-------|-------|------|       |------+--------+-------.
 *                               |       |       |  Up  |       | Home |        |       |
 *                               |BSps/L1| LGui  |------|       |------|  -/~L1 | Space |
 *                               |       |       | Down |       |  End |        |       |
 *                               `----------------------'       `-----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,      KC_Z,        KC_X,          KC_C,   KC_V, KC_B, ALL_T(KC_RGHT),
        ALL_T(KC_NO), CTL_T(KC_UP),ALT_T(KC_DOWN),KC_LEFT,GUI_T(KC_RGHT),
                                                                KC_SPC, ALT_T(KC_ENT),
                                                                        KC_UP,
                                               LT(SYMB,KC_BSPC),KC_LGUI,KC_DOWN,
        // right hand
...
[SYMB] = KEYMAP(
        ...
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,   KC_TRNS,LGUI(KC_T),KC_TRNS,
        ...
        KC_TRNS,KC_MINS,KC_RCBR,KC_RBRC,KC_UNDS,KC_TRNS,KC_F12,
...
[CALC] = KEYMAP(
        ...
        KC_TRNS, KC_COMM, KC_1,    KC_2,    KC_3,    KC_ASTR, KC_TRNS,
