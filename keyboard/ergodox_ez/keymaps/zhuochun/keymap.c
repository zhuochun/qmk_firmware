 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *    | ~L1 |Up/Ctl| Down |LftAlt|RgtGui|                                       |   =  |   -  |   [  |   ]  | ~L1 |
 *    `---------------------------------'                                       `---------------------------------'
 *                                       ,--------------.       ,---------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_FN1,CTL_T(KC_UP), KC_DOWN,ALT_T(KC_LEFT), GUI_T(KC_RGHT),
...
[SYMB] = KEYMAP(
        ...
        KC_TRNS, KC_AMPR, KC_1,   KC_2,  KC_3,   KC_ASTR, KC_TRNS,
                          KC_EQL, KC_0,  KC_DOT, KC_SLSH, KC_TRNS,
        KC_TRNS, KC_CALC,
        KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS
),
 ...
 * |        |      |      |      |      |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | XXXX |      |      | Lclk | Rclk |                                       |VolUp |VolDn | Mute |      | XXXX |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
