 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | ~L1  |=/Ctrl|  '"  |  Up  |Dwn/L2|                                       |Lft/L2| Right|   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | LAlt | PgUp |       | Home  |Ctrl/Esc|
 *                                 ,------|------|------|       |-------+--------+------.
 *                                 |      |      | PgDn |       | End   |        |      |
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_FN1,        KC_EQL,  KC_QUOT, KC_UP, LT(MDIA, KC_DOWN),
                                                                     KC_LALT,   KC_PGUP,
                                                                                KC_PGDN,
